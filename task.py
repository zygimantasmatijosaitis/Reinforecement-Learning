...
class Task():
    ...
    def get_reward(self):
        ...
        #penalize on how far from the target   
        #reward = 1.-.3*(abs(self.sim.pose[:3] - self.target_pos)).sum()
        # initial reward based on z velocity
        ...
        #Then the drone needs to keep being stable and avoid rotation. penalize every increase in euler angles.

        euler_angles = self.sim.pose[3:6].sum()
        reward -= euler_angles
        
         ## reward on how close the vertical coordinates to target
